...
describe GoodsController do
  ...
  # GoodsController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new Good" do
        expect {
          post :create, {:good => valid_attributes}, valid_session
        }.to change(Good, :count).by(1)
      end

      it "assigns a newly created good as @good" do
        post :create, {:good => valid_attributes}, valid_session
        expect(assigns(:good)).to be_a(Good)
        expect(assigns(:good)).to be_persisted
      end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved good as @good" do
        ...
        allow_any_instance_of(Good).to receive(:save).and_return(false)
        post :create, {:good => { "name" => "invalid value" }}, valid_session
        expect(assigns(:good)).to be_a_new(Good)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested good" do
        ...
        expect_any_instance_of(Good).to receive(:update).with({ "name" => "MyText" })
        put :update, {:id => good.to_param, :good => { "name" => "MyText" }}, valid_session
      end

      it "assigns the requested good as @good" do
        good = Good.create! valid_attributes
        put :update, {:id => good.to_param, :good => valid_attributes}, valid_session
        expect(assigns(:good)).to eq(good)
      end
    ...
    describe "with invalid params" do
      it "assigns the good as @good" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        allow_any_instance_of(Good).to receive(:save).and_return(false)
        put :update, {:id => good.to_param, :good => { "name" => "invalid value" }}, valid_session
        expect(assigns(:good)).to eq(good)
      end
